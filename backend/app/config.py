...
class AppSettings(BaseSettings):
    ...
    history_scan_driver_interval_seconds: float = Field(default=15.0, ge=1.0, le=3600.0)
    history_scan_driver_limit: int = Field(default=4, ge=1, le=100)
    history_scan_driver_batch_size: int = Field(default=250, ge=1, le=1000)
