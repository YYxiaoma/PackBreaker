...
class OperationKind(StrEnum):
    ...
    FILESYSTEM_REPAIR_CLEANUP = "FILESYSTEM_REPAIR_CLEANUP"
...
_OPERATION_EVENT_IDENTITIES: dict[str, tuple[str, str]] = {
    ...
    "CLEANUP_REPAIR_TARGET": ("FILESYSTEM_REPAIR_CLEANUP", "文件系统修复目标清理"),
...
_OPERATION_KINDS: dict[str, OperationKind] = {
    ...
    "CLEANUP_REPAIR_TARGET": OperationKind.FILESYSTEM_REPAIR_CLEANUP,
